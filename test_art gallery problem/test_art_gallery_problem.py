...
import pygame
import pandas as pd
from test_rysowanie_okna import *
from test_funkcje_pomocnicze import *
from test_triangulacja import zapisz_obrazy
...
class TestPunkty:
    def test_liczba_punktów(self):
        assert len(pd.read_csv(r'test_agp_project/test_pliki_wielokat/wspolrzedne_punktow.csv')) > 2
